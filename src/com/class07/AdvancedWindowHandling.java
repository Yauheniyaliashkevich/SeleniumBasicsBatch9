...
public class AdvancedWindowHandling {
    ...
    public static void main(String[] args) {
        ...
        String mainPadeWindowHandle = driver.getWindowHandle();
        ...
        while (it.hasNext()){ //start iterating through handles
           ...
           if(!handle.equals(mainPadeWindowHandle)){ //set a condition
        ...
        driver.switchTo().window(mainPadeWindowHandle); //switch back to parent
        instagramButton.click();
